...
public class AddressSoap  implements java.io.Serializable {
    ...
    /**
     * Gets the mvccVersion value for this AddressSoap.
     * 
     * @return mvccVersion
     */
    ...
    /**
     * Sets the mvccVersion value for this AddressSoap.
     * 
     * @param mvccVersion
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.kernel.portal.liferay.com", "AddressSoap"));
